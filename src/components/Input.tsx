...
const Input: React.FC<Props> = (e: Props) => {
    ...
    const getClassName = useCallback(() => {
        ...
        const border =
            configs?.colors?.border?.focus ??
            DEFAULT_BORDER_COLOR.focus[primaryColor as keyof typeof DEFAULT_BORDER_COLOR.focus];
        const ring =
            configs?.colors?.ring?.["second-focus"] ??
            DEFAULT_RING_COLOR["second-focus"][
